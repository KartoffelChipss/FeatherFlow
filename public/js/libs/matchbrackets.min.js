    ...
    function e(t, e, n) {
        for (
            ...
            l &&
                ...
                c.push(
                    t.markText(l.from, k(l.from.line, l.from.ch + 1), {
                        className: h,
                    })
                ),
                l.to &&
                    ...
                    c.push(
                        t.markText(l.to, k(l.to.line, l.to.ch + 1), {
                            className: h,
                        })
                    ));
        }
