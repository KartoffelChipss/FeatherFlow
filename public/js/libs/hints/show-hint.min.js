    ...
    function i(o, t) {
        ...
        var f,
            ...
            H =
                ...
                o.options.moveOnOverlap
                    ? l.getBoundingClientRect()
                    : new DOMRect()),
            e =
                !!o.options.paddingForScrollbar &&
                ...
                (this.onScroll = function () {
                    var t = s.getScrollInfo(),
                        ...
                        n =
                            i -
                            (r.pageYOffset ||
                                (c.documentElement || c.body).scrollTop)
                    if (
                        (v || (n += l.offsetHeight),
                        n <= e.top || n >= e.bottom)
                    )
                        return o.close()
                    ;(l.style.top = i + 'px'),
                        (l.style.left = m + f.left - t.left + 'px')
                })
            ),
        ...
        S.registerHelper('hint', 'fromList', function (t, e) {
            for (
                var i,
                    ...
                    c =
                        (t.start < n.ch &&
                        /\w/.test(t.string.charAt(n.ch - t.start - 1))
