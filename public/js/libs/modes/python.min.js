    ...
    x.registerHelper('hintWords', 'python', v.concat(z)),
        x.defineMode('python', function (t, l) {
            ...
            var c,
                ...
                r = z,
                p =
                    (null != l.extra_keywords &&
                        (n = n.concat(l.extra_keywords)),
                    null != l.extra_builtins &&
                        (r = r.concat(l.extra_builtins)),
            ...
            return {
                ...
                indent: function (e, t) {
                    if (e.tokenize != i)
                        return e.tokenize.isString ? x.Pass : 0;
                    var n = w(e),
                        e =
                            n.type == t.charAt(0) ||
                            ('py' == n.type &&
