        ...
        return {
            ...
            token: function (e, t) {
                ...
                return (
                    ...
                    'def' ==
                        (o =
                            y.token && void 0 !== (r = y.token(e, t, o))
                                ? r
                                : o) &&
                        !1 === a.styleDefs &&
                        (o = 'variable'),
            ...
            indent: function (e, t) {
                ...
                if (
                    ...
                    for (
                        ;
                        'statement' == n.type &&
                        a.dontIndentStatements.test(n.info);
    ...
    b(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
        ...
        b('text/x-java', {
            ...
            hooks: {
                ...
                '"': function (e, t) {
                    return (
                        !!e.match(/""$/) && ((t.tokenize = x), t.tokenize(e, t))
                    );
                },
            },
        ...
        b('text/x-scala', {
            ...
            hooks: {
                ...
                '/': function (e, t) {
                    return (
                        !!e.eat('*') && ((t.tokenize = v(1)), t.tokenize(e, t))
                    );
                },
            },
