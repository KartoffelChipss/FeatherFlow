!(function (e) {
    ...
    'use strict';
    function e(e) {
        for (var t = {}, _ = e.split(' '), r = 0; r < _.length; ++r)
            t[_[r]] = !0;
        return t;
    }
    function o(s, i, l) {
        return 0 == s.length
            ...
            : function (e, t) {
                  for (var _ = s[0], r = 0; r < _.length; r++)
                      if (e.match(_[r][0]))
                          return (t.tokenize = o(s.slice(1), i)), _[r][1];
    ...
    function n(n, a) {
        return function (e, t) {
            var _ = e,
                ...
                s = n,
                i = a;
            if ((!1 !== i && _.match('${', !1)) || _.match('{$', !1))
                return (r.tokenize = null), 'string';
            if (!1 !== i && _.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
                return (
                    _.match('[', !1) &&
                        (r.tokenize = o(
                            [
                        ...
                        if ((r = e.match(/^<<\s*/))) {
                            var _ = e.eat(/['"]/),
                                r =
                                    ...
                                    e
                                        .current()
                                        .slice(r[0].length + (_ ? 2 : 1)));
                            if ((_ && e.eat(_), r))
                                return (
                                    (t.tokStack || (t.tokStack = [])).push(
                                        r,
                                        0
                                    ),
                                    (t.tokenize = n(r, "'" != _)),
                    ...
                    '}': function (e, t) {
                        return (
                            t.tokStack &&
                                ...
                                !--t.tokStack[t.tokStack.length - 1] &&
                                (t.tokenize = n(
                                    t.tokStack[t.tokStack.length - 2]
                                )),
                            !1
                        );
                    },
            ...
            return {
                ...
                token: function (e, t) {
                    ...
                    if (
                        ...
                        return null == t.php.tokenize && e.match('?>')
                            ? ((t.curMode = l),
                              (t.curState = t.html),
                              t.php.context.prev || (t.php = null),
                              'meta')
                            : n.token(e, t.curState);
                    if (e.match(/^<\?\w*/))
                        return (
                            (t.curMode = n),
                            t.php ||
                    ...
                    if ('"' == t.pending || "'" == t.pending) {
                        ...
                        r =
                            t.pending && e.pos < t.pending.end
                                ? ((e.pos = t.pending.end), t.pending.style)
                                : l.token(e, t.curState);
                    t.pending && (t.pending = null);
                    var s,
                        i = (_ = e.current()).search(/<\?/);
                    return (
                        -1 != i &&
                            ('string' == r &&
                            (s = _.match(/[\'\"]$/)) &&
                            !/\?>/.test(_)
                                ? (t.pending = s[0])
                                : (t.pending = { end: e.pos, style: r }),
                            e.backUp(_.length - i)),
                        r
                    );
                },
                indent: function (e, t, _) {
                    return (e.curMode != n && /^\s*<\//.test(t)) ||
                        (e.curMode == n && /^\?>/.test(t))
                        ? l.indent(e.html, t, _)
                        : e.curMode.indent(e.curState, t, _);
                },
                blockCommentStart: '/*',
                blockCommentEnd: '*/',
                lineComment: '//',
