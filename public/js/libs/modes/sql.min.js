!(function (e) {
    ...
    a.defineMode('sql', function (r, e) {
        var i = e.client || {},
            n = e.atoms || { false: !0, true: !0, null: !0 },
            s = e.builtin || y(v),
            o = e.keywords || y(f),
            l = e.operatorChars || /^[*+\-%<>!=&|~^\/]/,
            c = e.support || {},
            ...
            return (c.hexNumber &&
                ...
                (c.binaryNumber &&
                    ((('b' == r || 'B' == r) && e.match(/^'[01]*'/)) ||
                        ('0' == r && e.match(/^b[01]+/))))
                ? 'number'
                : 47 < r.charCodeAt(0) && r.charCodeAt(0) < 58
                  ? (e.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/),
                    c.decimallessFloat && e.match(/^\.(?!\.)/),
                    'number')
                  : '?' == r && (e.eatSpace() || e.eol() || e.eat(';'))
                    ? 'variable-3'
                    : "'" == r || ('"' == r && c.doubleQuote)
                      ? ((t.tokenize = h(r)), t.tokenize(e, t))
                      : !(
                              (c.nCharCast && ('n' == r || 'N' == r)) ||
                              (c.charsetCast &&
                                  '_' == r &&
                        ...
                        ? c.escapeConstant &&
                          ('e' == r || 'E' == r) &&
                          ("'" == e.peek() ||
                              ('"' == e.peek() && c.doubleQuote))
                            ? ((t.tokenize = function (e, t) {
                                  return (t.tokenize = h(e.next(), !0))(e, t)
                              }),
                              'keyword')
                            : (c.commentSlashSlash && '/' == r && e.eat('/')) ||
                                (c.commentHash && '#' == r) ||
                                ('-' == r &&
                                    e.eat('-') &&
                                    (!c.commentSpaceRequired || e.eat(' ')))
                              ? (e.skipToEnd(), 'comment')
                              : '/' == r && e.eat('*')
        ...
        return {
            ...
            blockCommentStart: '/*',
            blockCommentEnd: '*/',
            lineComment: c.commentSlashSlash
                ? '//'
                : c.commentHash
                  ? '#'
                  : '--',
    ...
    a.defineMIME('text/x-sql', {
        ...
        a.defineMIME('text/x-trino', {
            ...
            atoms: y('false true null unknown'),
            operatorChars: /^[[\]|<>=!\-+*/%]/,
            dateSQL: y('date time timestamp zone'),
            support: y('ODBCdotTable decimallessFloat zerolessFloat hexNumber'),
        })
})
