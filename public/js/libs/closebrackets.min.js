!(function (e) {
    ...
    S.defineOption('autoCloseBrackets', !1, function (e, t, n) {
        n && n != S.Init && (e.removeKeyMap(i), (e.state.closeBrackets = null)),
            t &&
                (r(y(t, 'pairs')), (e.state.closeBrackets = t), e.addKeyMap(i));
    });
    var i = {
    ...
    function O(e) {
        ...
        return (
            (t && !t.override && e.getModeAt(e.getCursor()).closeBrackets) || t
        );
    }
    function m(e, t) {
        for (
