!(function (e) {
    ...
    function d(e, r, o) {
        return e.getSearchCursor(r, o, { caseFold: n(r), multiline: !0 })
    }
    function m(e, r, o, t, n) {
        e.openDialog
            ? e.openDialog(r, n, {
                  value: t,
                  selectValueOnOpen: !0,
    ...
    function y(e, r, o) {
        ...
        ;(r.queryText = o),
            (r.query = a(o)),
            e.removeOverlay(r.overlay, n(r.query)),
            (r.overlay =
                ((t = r.query),
                (o = n(r.query)),
                'string' == typeof t
            ...
            e.showMatchesOnScrollbar &&
                ...
                (r.annotate = e.showMatchesOnScrollbar(r.query, n(r.query))))
    }
    function o(n, r, e, o) {
        var t = p(n)
        if (t.query) return g(n, r)
        var a,
            i,
            s,
            c,
            l,
            u = n.getSelection() || t.lastQuery
        u instanceof RegExp && 'x^' == u.source && (u = null),
            e && n.openDialog
                ? ((a = null),
                  (i = function (e, r) {
                      f.e_stop(r),
                          e &&
                              (e != t.queryText &&
                                  (y(n, t, e),
                                  (t.posFrom = t.posTo = n.getCursor())),
                              a && (a.style.opacity = 1),
                              g(n, r.shiftKey, function (e, r) {
                                  var o
                                  r.line < 3 &&
                                      document.querySelector &&
                                      (o =
                                          n.display.wrapper.querySelector(
                                              '.CodeMirror-dialog'
                                          )) &&
                                      o.getBoundingClientRect().bottom - 4 >
                                          n.cursorCoords(r, 'window').top &&
                                      ((a = o).style.opacity = 0.4)
                              }))
                  }),
                  (e = C((s = n))),
                  (c = u),
                  (l = function (e, r) {
                      var o = f.keyName(e),
                          t = n.getOption('extraKeys'),
                          t = (t && t[o]) || f.keyMap[n.getOption('keyMap')][o]
                      'findNext' == t ||
                      'findPrev' == t ||
                      'findPersistentNext' == t ||
                      'findPersistentPrev' == t
                          ? (f.e_stop(e), y(n, p(n), r), n.execCommand(t))
                          : ('find' != t && 'findPersistent' != t) ||
                            (f.e_stop(e), i(r, e))
                  }),
                  s.openDialog(e, i, {
                      value: c,
                  ...
                  o && u && (y(n, t, u), g(n, r)))
                : m(n, C(n), 'Search for:', u, function (e) {
                      e &&
                          !t.query &&
    ...
    function g(o, t, n) {
        o.operation(function () {
            var e = p(o),
                r = d(o, e.query, t ? e.posFrom : e.posTo)
            ;(r.find(t) ||
                (r = d(
                    o,
                    e.query,
                    t ? f.Pos(o.lastLine()) : f.Pos(o.firstLine(), 0)
                )).find(t)) &&
                (o.setSelection(r.from(), r.to()),
                o.scrollIntoView({ from: r.from(), to: r.to() }, 20),
                (e.posFrom = r.from()),
                (e.posTo = r.to()),
                n && n(r.from(), r.to()))
        })
    ...
    function x(e, r) {
        ...
        for (var n = 2; n < arguments.length; n++) {
            var a = arguments[n]
            t.appendChild('string' == typeof a ? document.createTextNode(a) : a)
        }
        return t
    }
    function C(e) {
        ...
        return (
            r.setAttribute('for', 'CodeMirror-search-field'),
            x(
                '',
                null,
                r,
    ...
    function b(r, t, n) {
        r.operation(function () {
            for (var o, e = d(r, t); e.findNext(); )
                'string' != typeof t
                    ? ((o = r.getRange(e.from(), e.to()).match(t)),
                      e.replace(
                          n.replace(/\$(\d)/g, function (e, r) {
                              return o[r]
                          })
                      ))
                    : e.replace(n)
    ...
    function t(u, e) {
        ...
        u.getOption('readOnly') ||
            ((r = u.getSelection() || p(u).lastQuery),
            (t = x(
                '',
                null,
                x(
                    'span',
                    { className: 'CodeMirror-search-label' },
                    (o = e ? u.phrase('Replace all:') : u.phrase('Replace:'))
                ),
                ((t = u),
                x(
                    '',
